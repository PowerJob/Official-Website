...
function extraNavFuncs() {
    function a(t) {
        ...
        t.parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown",
        function(t) {
    ...
    $("body").on("click", ".dropdown-menu a.dropdown-toggle",
    function(t) {
        return a($(this))
    })
}
...
function stickyNavToggle() {
    ...
    if (o && (console.log("fill screen"), e = $(".fill-bloc-top-edge.sticky-nav").parent(), t = $(".sticky-nav").height(), a = "sticky animated fadeInDown"), $(window).scrollTop() > t) {
        if (!$(".sticky-nav").hasClass("sticky")) {
            if ($(".sticky-nav").addClass(a), t = $(".sticky-nav").height(), o) {
    ...
    else $(".sticky-nav").hasClass("sticky") && ($(".sticky-nav").removeClass(a).removeAttr("style"), e.removeAttr("style"))
}
