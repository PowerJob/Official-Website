...
default:
    ...
    e(window).on("load.bs.button.data-api", (function() {
        ...
        for (var r = 0,
        s = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length; r < s; r++) {
            var a = t[r];
    ...
    function dt() {
        ...
        ht(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", this.popper.style[ft("transform")] = ""),
        ...
        modifiers: {
            ...
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    return s.forEach((function(a, l) {
                        ...
                        t.offsets.popper, at(t.instance.popper, t.offsets.reference, t.placement)), t = ct(t.instance.modifiers, t, "flip"))
                    })),
                    t
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    p = void 0,
                    m = void 0;
                    if (m = "bottom" === h ? "HTML" === a.nodeName ? -a.clientHeight + u.bottom: -l.height + u.bottom: u.top, p = "right" === f ? "HTML" === a.nodeName ? -a.clientWidth + u.right: -l.width + u.right: u.left, s && d) c[d] = "translate3d(" + p + "px, " + m + "px, 0)",
                    c[h] = 0,
                    c[f] = 0,
    ...
    qt = function() {
        ...
        t._jQueryInterface = function(n, i) {
            return this.each((function() {
                ...
                r = s(s(s({},
                Mt), e(this).data()), "object" == typeof n && n ? n: {});
    ...
    e(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function(t) {
        ...
        var r = e(n).data("bs.modal") ? "toggle": s(s({},
    ...
    te = function() {
        ...
        n._setListeners = function() {
            ...
            this.config.selector ? this.config = s(s({},
            this.config), {},
            {
                trigger: "manual",
                selector: ""
        ...
        n._getConfig = function(t) {
            ...
            return Object.keys(n).forEach((function(t) { - 1 !== Kt.indexOf(t) && delete n[t]
            })),
            "number" == typeof(t = s(s(s({},
    ...
    fe = function() {
        ...
        n._getConfig = function(t) {
            if ("string" != typeof(t = s(s({},
            ue), "object" == typeof t && t ? t: {})).target && l.isElement(t.target)) {
    ...
    _e = function() {
        ...
        n._getConfig = function(t) {
            return t = s(s(s({},
            ve), e(this._element).data()), "object" == typeof t && t ? t: {}),
